...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="fixed left-0 flex items-center justify-center w-screen h-screen space-x-6 bg-gray-300">
        <div className="fixed left-0 flex flex-col items-center w-60 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
